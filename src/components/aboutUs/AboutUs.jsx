    ...
    <div className="font-sans text-white min-h-screen">
      ...
      <section id="about" className="container mx-auto px-6 py-10">
        ...
        >
          ...
          <motion.p variants={fadeIn} className="text-lg text-gray-300 mb-8">
          ...
          <motion.div variants={fadeIn} className="bg-gray-800 bg-opacity-70 p-6 rounded-xl border-l-4 border-yellow-500 mt-8 mb-6">
      ...
      <section id="services" className="container mx-auto px-6 py-8">
        ...
        >
          ...
          <motion.p variants={fadeIn} className="text-lg text-gray-300 mb-12 text-center max-w-3xl mx-auto">
      ...
      <section className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <motion.p variants={fadeIn} className="text-lg text-gray-300 mb-12 text-center">
            Modern Solutions, Proven Expertise
          </motion.p>

          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <motion.div variants={fadeIn} className="bg-gray-800 bg-opacity-50 p-6 rounded-xl hover:transform hover:scale-101 border-blue-500 hover:border-l-2 hover:border-r-2 transition-all duration-300 ease-in-out">
          ...
          <motion.div variants={fadeIn} className="bg-gray-800 bg-opacity-70 p-6 rounded-xl border-l-4 border-yellow-500 mb-8">
      ...
      <section className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <motion.div variants={fadeIn} className="mb-20 bg-gray-900 bg-opacity-70 p-6 rounded-xl border-l-4 border-r-4 border-yellow-500 hover:border-yellow-300 transition-all duration-300 ease">
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold mb-6">
              Collaborative Success
            </motion.h2>
            <motion.p variants={fadeIn} className="text-lg text-gray-300 mb-6">
            ...
            <motion.ul variants={fadeIn} className="list-disc pl-6 space-y-3 text-gray-300">
          ...
          >
            ...
            <div className="bg-gray-900 bg-opacity-50 text-center rounded-full mb-2 border-4 border-gray-800">
            ...
            <div className="grid md:grid-cols-3 gap-2">
              {/* Card 1 */}
              <motion.div
                className="bg-gray-800 text-center bg-opacity-50 p-6 rounded-full border-4 border-gray-900 hover:bg-gray-900 transition-all duration-500 easeOut"
          ...
          <motion.div variants={fadeIn}
            className="bg-gray-800 bg-opacity-70 p-2 mb-25 rounded-xl border-l-4 border-yellow-500">
          ...
          <motion.div variants={fadeIn} className="mb-20 border-t-4 border-b-4 rounded-xl p-10 border-yellow-500 bg-gray-900 bg-opacity-70">
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-bold mb-6">
            ...
            <motion.ul variants={fadeIn}
              className="list-disc pl-6 space-y-3 text-gray-300">
          ...
          >
            {/* Momentum & Cient Wins Section */}
            <div className="bg-gray-950 bg-opacity-50 p-6 rounded-xl mb-8">
              <h3 className="text-3xl font-bold mb-3 text-yellow-500">Innovation Built for Your Needs</h3>
          ...
          <motion.div variants={fadeIn} className="bg-gray-800 bg-opacity-70 p-6 rounded-xl border-l-4 border-yellow-500 mb-4">
      ...
      <section id="contact" className="container mx-auto px-6 py-5">
        ...
        >
          ...
          <motion.p variants={fadeIn} className="text-lg text-gray-300 mb-10">
